...
var CountDown=10
var CARSELECTOR=6
var carS1,carS2,fps,carS3,carS4,playerCar1,conBack,browseCheck,browseCheck1;
var FIRSTBG=9
var PLAYERCAR1=7
var BUGATTIGAME=8
var OTHERGAM=12
...
browseCheck=createButton("Google")
browseCheck.position(100,100)
browseCheck.size(150,70)

browseCheck1=createButton("Other")
browseCheck1.position(450,100)
browseCheck1.size(150,70)
browseCheck1.hide();
browseCheck.hide();
...
if(gameState===START){
  ...
  buttun.mousePressed(()=>{ 
    if(navigator.vendor==="Google Inc."){
      print("You are in a good Browser")
      browseCheck1.hide();
      browseCheck.hide();
      gameState=INS;
    }
    else{
      text("Which is your Browser",10,20)
      browseCheck.show();
      browseCheck1.show();
      open("https://google.com/")
      browseCheck.mousePressed(()=>{
        browseCheck1.hide();
        browseCheck.hide();
    ...
    browseCheck1.mousePressed(()=>{
      gameState=WRONGBROWSER
      open("https://google.com/")
    }) 
      
      
      print("You are not in a good Browser")
    }
...
if(gameState===WRONGBROWSER){
  clear();
  text("Sorry Pease Join this game only in Google :(",30,100)
}
...
function updateUserWindowInfo(){
  var contestantIndex = "Players WindowInfo/player"+" "+input.value();
